...
export function VideoPlaceholder() {
  ...
  return (
    <div
      className="relative aspect-video w-full rounded-2xl overflow-hidden shadow-2xl border border-slate-200 group cursor-pointer"
    ...
    >
      ...
      <div className="absolute inset-4 md:inset-8 rounded-xl bg-white/5 backdrop-blur-sm border border-white/10 overflow-hidden">
        ...
        <div className="p-6 space-y-4">
          <div className="flex items-center gap-4">
            ...
            <div className="w-24 h-4 rounded bg-blue-500/30" />
          </div>
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center z-10">
        ...
        >
          {isHovered ? (
            <Pause className="w-8 h-8 md:w-10 md:h-10 text-slate-900" />
          ) : (
        ...
        <p className="mt-1 text-white/50 text-xs">2 minute demo</p>
      </div>
