        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-slate max-w-none">
            ...
            <section className="mb-10">
              ...
              <h3 className="text-lg font-medium text-slate-800 mb-3">4.1 Pricing</h3>
              <p className="text-slate-600 leading-relaxed mb-4">
              ...
              <h3 className="text-lg font-medium text-slate-800 mb-3">4.2 Free Trial</h3>
              <p className="text-slate-600 leading-relaxed mb-4">
              ...
              <h3 className="text-lg font-medium text-slate-800 mb-3">4.3 Refunds</h3>
              <p className="text-slate-600 leading-relaxed">
