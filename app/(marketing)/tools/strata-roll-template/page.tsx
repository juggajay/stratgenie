    ...
    <div className="py-12 px-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-10">
          <div className="w-16 h-16 bg-[#F8F5F0] rounded-[20px] flex items-center justify-center mx-auto mb-4">
            ...
            <CardContent>
              {!submitted ? (
                ...
                <div className="space-y-4">
                  <div className="p-4 bg-[#F8F5F0] border border-[#E8E4DE] rounded-lg flex items-start gap-3">
                    <div className="w-8 h-8 bg-[#F8F5F0] rounded-full flex items-center justify-center flex-shrink-0">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <button
                      ...
                      className="p-4 border border-[#E8E4DE] rounded-lg hover:border-[#FF6B35] hover:bg-[#F8F5F0] transition-colors text-center"
                    >
                      <Download className="w-6 h-6 text-[#FF6B35] mx-auto mb-2" />
                      <span className="block text-sm font-medium text-[#1a1a2e]">
                        Excel (.xlsx)
                      </span>
                      <span className="text-xs text-[#6b6b8a]">Editable spreadsheet</span>
                    </button>
                    <button
                    ...
                    >
                      ...
                      <span className="text-xs text-[#6b6b8a]">Print-ready format</span>
                    </button>
                  </div>
                </div>
              )}
                ...
                <ul className="space-y-3">
                  {[
                    ...
                    <li key={item} className="flex items-center gap-3 text-sm">
                      <div className="w-5 h-5 bg-[#F8F5F0] rounded-full flex items-center justify-center flex-shrink-0">
                        <Check className="w-3 h-3 text-[#FF6B35]" />
                      </div>
                      <span className="text-[#3d3d5c]">{item}</span>
                    </li>
                  ))}
                </ul>
              </CardContent>
        ...
        <section className="mt-16">
          <h2 className="text-xl font-display font-semibold text-[#1a1a2e] mb-6">
